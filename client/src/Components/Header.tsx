      ...
      <div className="w-full flex justify-between py-6 mx-6 sm:mx-10 lg:max-w-6xl lg:px-0 ">
        ...
        <div className="flex items-center gap-4 lg:gap-6">
          ...
          >
            ...
            {totalQuantity > 0 && (
              <span className="text-white text-sm bg-orange absolute -top-3 rounded-full px-2">
                {totalQuantity}
              </span>
            )}
          </button>
          {!user ? (
            <Link to={'/auth'}>
              <button className="text-white font-bold px-2 py-[2px] hover:text-orange">
                Sign In
              </button>
            </Link>
          ) : (
            <button
              className="text-white font-bold px-2 py-[2px] hover:underline hover:text-orange"
              onClick={() => {
