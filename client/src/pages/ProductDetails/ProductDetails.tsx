...
export default function ProductDetails() {
  return (
    <>
      ...
      <div className="mx-auto max-w-xs sm:max-w-2xl lg:max-w-5xl">
      ...
      <div className="max-w-xs sm:max-w-2xl mx-auto lg:flex lg:max-w-5xl gap-[125px] lg:my-40">
        <Features />
        <InTheBox />
      </div>
      <div className="max-w-xs sm:max-w-2xl lg:max-w-5xl mx-auto flex flex-col gap-6 sm:grid grid-rows-2 grid-cols-[41.5%_58.5%] sm:gap-4">
        <img
          src={galleryPic1Tablet}
          alt="mark2 headphones"
          className="rounded-lg self-start"
        />
        <img
          src={galleryPic2Tablet}
          alt="mark2 headphones"
          className="rounded-lg row-start-2"
        />
        <img
          src={galleryPic3Tablet}
          alt="mark2 headphones"
          className="rounded-lg row-start-1 row-span-2 "
        />
      </div>
      <div className="max-w-xs sm:max-w-2xl lg:max-w-5xl mx-auto my-28">
        <h3 className="uppercase font-bold leading-9 text-2xl mb-10 text-center">
          you may also like
        </h3>
        <div className="sm:flex gap-3 lg:gap-8 justify-between">
          <OtherProducts />
          <OtherProducts />
          <OtherProducts />
        </div>
